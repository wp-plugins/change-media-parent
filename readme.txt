...
1. Link and Post Selection window

== Frequently Asked Questions ==

= How can I reset a media item to Unattached? =

This plugin does not currently offer this option. You may wish to try this plugin http://wordpress.org/extend/plugins/change-attachment-parent/
